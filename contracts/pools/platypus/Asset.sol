...
import '../../interfaces/IMonoAsset.sol';
 ...
 */
contract Asset is Initializable, OwnableUpgradeable, ERC20Upgradeable, IMonoAsset {
     ...
     */
    function decimals() public view override(IMonoAsset, ERC20Upgradeable) returns (uint8) {
